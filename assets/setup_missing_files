...
from .stats import create_enhanced_stats_component
...
cat > ui/components/stats.py << 'EOF'
# ui/components/stats.py - Minimal version
...
pip install --quiet pandas dash plotly dash-bootstrap-components dash-cytoscape
